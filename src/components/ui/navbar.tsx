...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-[#0022FF] w-full relative">
      <div className="w-full flex items-center justify-between px-4 md:px-[110px] h-[121px]">
        <div className="flex items-center w-[80px]">
          <Link to="/">
            <img src="/Logo/logo-horizontal 1.png" alt="Logo" />
          </Link>
        </div>

        <div className="hidden md:flex flex-grow justify-center space-x-[80px]">
          <Link to="/carro" className="text-white text-[18px] hover:text-gray-300">
            Carros
          </Link>
          <Link to="/motos" className="text-white text-[18px] hover:text-gray-300">
            Motos
          </Link>
          <Link to="/carrinhas" className="text-white text-[18px] hover:text-gray-300">
            Carrinhas
          </Link>
        </div>
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="md:hidden bg-[#0022FF] flex flex-col items-center space-y-4 py-4">
          <Link to="/carro" className="text-white text-[18px] hover:text-gray-300">
            Carros
          </Link>
          <Link to="/motos" className="text-white text-[18px] hover:text-gray-300">
